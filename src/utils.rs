...
pub(crate) fn poly_mul<F: PrimeField>(a: &DensePolynomial<F>, b: &DensePolynomial<F>) -> DensePolynomial<F> {
...
pub(crate) fn poly_div<F: PrimeField>(a: &DensePolynomial<F>, b: &DensePolynomial<F>) -> (DensePolynomial<F>, DensePolynomial<F>) {
    ...
    (DensePolynomial::from_coefficients_vec(q), a)
}
